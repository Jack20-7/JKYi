#ifndef _JKYI_PROTOCOL_H_
#define _JKYI_PROTOCOL_H_
...
public:
    ...
    virtual bool serializeToByteArray(ByteArray::ptr byetarray)override;
...
public:
    ...
    void setResultStr(const std::string& str) { m_resultStr = str; }
